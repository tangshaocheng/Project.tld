//当前页
document
		.write("<input type='hidden' name='currentPageNum' id='currentPageNum' value='1'/>");
// 每页条数
document
		.write("<input type='hidden' name='everyPageNum' id='everyPageNum' value='20'/>");
// 共有页面数
document
		.write("<input type='hidden' name='totalPageNum' id='totalPageNum' value='1'/>");
...
document
		.write("当前第[<a id='ajaxcurrpage'></a>]页</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
document
		.write("<span id='ajaxfpage'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
document
		.write("<span id='ajaxnpage'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
document
		.write("<span id='ajaxppage'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
document
		.write("<span id='ajaxepage'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
