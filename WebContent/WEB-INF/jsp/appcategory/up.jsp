	...
	<div class="main">
		...
		<div class="selectthings">
			<form name="tform" id="tform"
				action="${pageContext.request.contextPath}/appcategory/up.htm"
				...
				<table>
					...
					<tr class="odd2">
						...
						<td width="75%"><input type="text" name="name" id="name"
							value="${vo.name}" maxlength="100" style="width:300px">
						</td>
					</tr>
					<tr class="even">
						<td width="25%">序号<font color="red">*</font>：</td>
						<td width="75%"><input type="text" name="seq" id="seq"
							value="${vo.seq}" maxlength="11" style="width:300px"
							onkeyup="this.value=this.value.replace(/\D/g,'")" >
						</td>
					</tr>
					<tr class="even">
						<td width="25%">描述<font color="red">*</font>：</td>
						<td width="75%"><textarea id="remark" name="remark" rows="12"
								cols="96" maxlength="1000"
								style='padding:3px; font-family:"Courier New",Courier,monospace;'>${vo.remark}</textarea>
						</td>
					</tr>
					<tr class="even">
						<td width="25%">图标<font color="red">*</font>：</td>
						<td width="75%"><input type="file" name="icon" id="icon"
							onchange="previewPicture('icon');" style="width:200px"> <img
							name="icon-preview" id="icon-preview"
					...
					<tr class="even">
						...
						<td width="75%"><select id="pubStatus" name="pubStatus"
							style="width: 100px">
								<option value="1"
									<c:if test="${vo.pubStatus==1}"> selected</c:if>>是</option>
								<option value="0"
									<c:if test="${vo.pubStatus==0}"> selected</c:if>>否</option>
						</select></td>
					</tr>
					<tr class="even">
