				...
				<table>
					...
					<tr class="even">
						...
						<td width="75%"><input type="text" name="develope"
							id="develope" maxlength="50" style="width: 300px">
						</td>
					</tr>
					<tr class="odd2">
					...
					<tr class="odd2">
						<td>线上app信息：<font color="red">*</font>
						</td>
						<td>
							<table>
								<tr class="even">
									...
									<td width="75%"><input type="text" id="version"
										maxlength="100" name="version" style="width: 300px">
									</td>
								</tr>
								<tr class="even">
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" id="pakeage"
										maxlength="100" name="pakeage" style="width: 300px">
									</td>
								</tr>
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" id="mainClass"
										maxlength="100" name="mainClass" style="width: 300px">
									</td>
								</tr>
								<tr class="even">
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" name="osVersionMin"
										id="osVersionMin" maxlength="100" value="" style="width:300px">
									</td>
								</tr>
								...
								<tr class="even" title="appBatch_0">
									...
									<td width="75%"><input type="file" name="appBatch_0"
										id="appBatch_0" style="width: 300px">
									</td>
								</tr>
							</table></td>
					</tr>
							...
							<table>
								<tr class="even">
									...
									<td width="75%"><input type="text" id="embededVersion"
										maxlength="100" name="embededVersion" style="width: 300px">
									</td>
								</tr>
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" id="embededPakeage"
										maxlength="100" name="embededPakeage" style="width: 300px">
									</td>
								</tr>
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" id="embededMainClass"
										maxlength="100" name="embededMainClass" style="width: 300px">
									</td>
								</tr>
								<tr class="even">
									<td width="25%">内置apk程序：</td>
									<td width="75%"><input type="file" id="embededApp"
										name="embededApp" style="width: 300px">
									</td>
								</tr>
							</table></td>
					</tr>
					<tr class="even">
						...
						<td width="75%"><input type="text" name="singleWord"
							id="singleWord" maxlength="200" value="" style="width:400px">
						</td>
					</tr>
					<tr class="even">
					...
					<tr class="even">
						<td width="25%">
							<!-- 主图片1<font color="red">*</font> -->：</td>
						<td width="75%"><input type="file" id="mainPic"
							name="mainPic" style="width: 300px">
						</td>
					</tr>
					<tr class="odd2">
						<td width="25%">
							<!-- 主图片2<font color="red">*</font> -->：</td>
						<td width="75%"><input type="file" id="mainPic2"
							name="mainPic2" style="width: 300px">
						</td>
					</tr>
					<tr class="even">
