...
<link href="${pageContext.request.contextPath}/css/new/axurerp_left.css"
	...
	<script type="text/javascript">
		...
		function getMenuTree() {
			ajaxPost("${pageContext.request.contextPath}/menutree_out.htm",
					buildTree);
		}
		function buildTree(data) {
			$("#browser").html(data[0]['tree']);
			$("div[class='u12']").hide();
			$("div[class='u10_img']").click(
					function() {
						var fatherid = $(this).attr("id");
						var hide = $(this).attr("hide");
						$("div[class='u12']").hide();
						$("div[class='u10_img']").each(
								function() {
									$(this).attr("hide", "0");
									$(this).css(
											"background-image",
											"url(${pageContext.request.contextPath}/img/new/left_files/"
													+ $(this).attr("id")
													+ "_menu.png)");
								});
						if (hide == '1') {
							...
							$(this).css(
									"background-image",
									"url(${pageContext.request.contextPath}/img/new/left_files/"
											+ fatherid + "_menu_sel.png)");
							$(this).attr("hide", "1");
							$("div[fatherid='" + fatherid + "']").show();
						}
					});
			$("img[class='raw_image']").click(
					function() {
						window.top.topFrame.funUrlViwe($(this).attr("title"));
						var id = $(this).attr("id");
						$("img[class='raw_image']").each(
								function() {
									$(this).attr(
											"src",
											"${pageContext.request.contextPath}/img/new/left_files/"
													+ $(this).attr("id")
													+ "_menu.png");
								});
						$(this).attr(
